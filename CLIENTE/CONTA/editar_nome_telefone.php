...
<div class="div-dados-esq">
    <label for="">Nome:  </label><input type="text" placeholder="<?php echo $_SESSION['nome']?>"><br>
    <label for="">Contacto:  </label><input type="text" placeholder="<?php echo $_SESSION['contacto']?>">
</div>
</div>
<hr class="hr">
 </center>
